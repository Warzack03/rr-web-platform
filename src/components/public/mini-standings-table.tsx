      ...
      <div className="mt-5 overflow-hidden border border-white/10 bg-[rgba(7,22,41,0.34)]">
        {rows.map((row) => (
          <div
            ...
            className={cn(
              "grid grid-cols-[3rem_minmax(0,1fr)_3rem] items-center gap-3 border-t border-white/8 px-3 py-3 first:border-t-0",
          ...
          >
            ...
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="truncate text-[1rem] font-semibold text-white">{row.team}</p>
                {row.isClub ? (
