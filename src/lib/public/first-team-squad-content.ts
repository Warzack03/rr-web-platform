...
const FIRST_TEAM_CORE_PLAYERS: FirstTeamSquadPlayer[] = [
  {
    id: "mark-evans",
    slug: "mark-evans",
    firstName: "Mark",
...
const FIRST_TEAM_DEPTH_PLAYERS: FirstTeamSquadPlayer[] = [
  {
    id: "victor-krane",
    slug: "victor-krane",
    firstName: "Victor",
...
const FIRST_TEAM_PLAYERS: FirstTeamSquadPlayer[] = [...FIRST_TEAM_CORE_PLAYERS, ...FIRST_TEAM_DEPTH_PLAYERS];
